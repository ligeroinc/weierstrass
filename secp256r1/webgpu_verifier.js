...
// include: /var/folders/pk/s671b_3s40x5svmjf71z4b0w0000gn/T/tmp3_9qo386.js
...
Module['FS_createPath']("/", "shader", true, true);
    ...
    loadPackage({"files": [{"filename": "/ecdsa_p256_verify.wasm", "start": 0, "end": 1247518}, {"filename": "/shader/bignum.wgsl", "start": 1247518, "end": 1285495}, {"filename": "/shader/sha256.wgsl", "start": 1285495, "end": 1293082}], "remote_package_size": 1293082});

  })();

// end include: /var/folders/pk/s671b_3s40x5svmjf71z4b0w0000gn/T/tmp3_9qo386.js
// include: /var/folders/pk/s671b_3s40x5svmjf71z4b0w0000gn/T/tmpc3_a7a8b.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/pk/s671b_3s40x5svmjf71z4b0w0000gn/T/tmpc3_a7a8b.js
...
// include: /var/folders/pk/s671b_3s40x5svmjf71z4b0w0000gn/T/tmpgucj9q4a.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/pk/s671b_3s40x5svmjf71z4b0w0000gn/T/tmpgucj9q4a.js
